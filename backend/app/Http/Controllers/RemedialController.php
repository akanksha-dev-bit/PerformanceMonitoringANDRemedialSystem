...
class RemedialController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'min_words'      => 'nullable|integer|min:1|max:10000',
            'max_words'      => 'nullable|integer|min:1|max:50000',
    ...
    /**
     * Teacher/Admin: list all submissions for a remedial action.
     */
    public function showSubmissions(RemedialAction $remedial)
    {
        ...
        $submissions = RemedialSubmission::where('remedial_action_id', $remedial->id)
            ->where('school_id', $user->school_id) // cross-school guard
